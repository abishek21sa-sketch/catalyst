      ...
      >
        ...
        >
          ...
          <span className="grid flex-1 gap-0.5">
            ...
            <small className="text-[11px] text-slate-500">MSFT · NASDAQ</small>
          </span>
      ...
      <section className="min-w-0 lg:ml-0 lg:flex-1">
        ...
        <div className="mx-auto max-w-[1500px] px-4 py-8 sm:px-8 lg:px-11">
          <div className="flex flex-col justify-between gap-5 sm:flex-row sm:items-end">
            <div>
              ...
              <h1 className="mt-3 text-3xl font-semibold tracking-[-.055em] sm:text-[39px]">
                Microsoft{' '}
                <span className="font-normal text-slate-500">Corporation</span>
              </h1>
            ...
            <section className="rounded-xl border border-slate-800 bg-[#101820]/75 p-4 sm:p-5">
              <div className="flex items-start justify-between">
                ...
                <label className="flex items-center gap-2 rounded-lg border border-slate-800 bg-[#101a21] px-2.5 py-2 text-[11px] text-slate-400">
                  ...
                  <select value={eventFilter} onChange={(event) => setEventFilter(event.target.value as EventFilter)} className="bg-transparent text-[11px] text-slate-400 outline-none">
              ...
              <div className="mt-5 flex flex-wrap items-center gap-3 text-[11px] text-slate-500">
                ...
                <span className="text-slate-600">{String(visibleEvents.length).padStart(2, '0')} events</span>
              </div>
          ...
          <div className="mt-4 grid gap-4 xl:grid-cols-[minmax(0,1.34fr)_minmax(330px,.66fr)]">
            <ResearchCard title="What to test next" kicker="WORKING HYPOTHESES">
